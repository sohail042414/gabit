...
abstract class BasePost extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('tags, status, create_time, update_time', 'default', 'setOnEmpty' => true, 'value' => null),
	...
	public function attributeLabels() {
		return array(
			'id' => Yii::t('app', 'ID'),
			'title' => Yii::t('app', 'Story Title/Heading'),
			'content' => Yii::t('app', 'Success Story/Content'),
			'tags' => Yii::t('app', 'Tags'),
