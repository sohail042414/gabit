...
<?php echo $form->hiddenField($model, 'user_id', array('type' => "hidden", 'value' => Yii::app()->frontUser->id)); ?>
    ...
    <div class="form-group preview-wrap">
        <?php
        if (!empty($model->uplod_fun_img)) {
            echo '<img class="preview_image" src="' . SITE_ABS_PATH_FUNDRAISER_IMAGE . $model->fundraiser_bg_image . '" alt="" />';
        }
        ?>
    </div>
    ...
    <div class="form-group">
        ...
        <?php echo $form->textField($model, 'benifi_age',  array('maxlength' => 3,'disabled'=>'disabled')); ?>
        <?php echo $form->error($model, 'benifi_age'); ?>   
    </div>
    
    <div class="form-group">
        <?php echo $form->labelEx($model, 'benifi_sex'); ?>
        <?php echo $form->dropDownList($model, 'benifi_sex', array('M' => Yii::t('app', 'Male'), 'F' => Yii::t('app', 'Female')),array('prompt' => '– Please Select –','disabled'=>'disabled')); ?>        
    ...
    <div class="form-group" >
        ...
        <div class="form-group" >
            <?php echo $form->labelEx($model, 'fund_manager_phone'); ?>
            <?php echo $form->textField($model, 'fund_manager_phone', array('maxlength' => 255)); ?>
            <?php echo $form->error($model, 'fund_manager_phone'); ?>               
        </div>
        <div class="form-group" >
        ...
        <h6 style='font-weight: normal;'>Include this fundraiser in <a target="_blank" href="<?php echo Yii::app()->createUrl('rewards'); ?>">donor reward program</a></h6>
        <div class="form-group" >
