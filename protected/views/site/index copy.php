                        ...
                        <?php foreach($categories as $category) { ?>                        
                            <div class="slide">
                                ...
                                <a href="<?php echo $category['category_url'] ?>">                                
                                    ...
                                    <h4 class="teg1-h4 teg1-color"><?php echo $category['amount']; ?></h4>
...
<div id="comment-row" style="padding: 0px; background:none;">
    <div class="inner-container">
        <div style="width: 70%; height:100%; float:left;">
            <div class="fb-like" data-href="https://web.facebook.com/profile.php?id=100083412519493" data-width="" data-layout="button" data-action="like" data-size="large" data-share="true"></div>
        </div>    
        <div style="width: 30%; height:100%;float:left;text-align:right;">
            <a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button" data-size="large" data-text="Visit Giveyourbit and see how you can raise funds for your cause or support a cause, follow us on twitter" data-url="https://giveyourbit.com/" data-via="giveyourbit" data-lang="en" data-show-count="false">Tweet</a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
        </div>
    </div> 
</div>
