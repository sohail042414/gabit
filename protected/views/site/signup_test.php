...
.label_cls{line-height:35px;}

#Users_agree_to_terms_em_ {
    margin-left: 154px;
    width: 200px;
}
#Users_agree_to_terms{float:left; margin:0 10px 0 0;}
#users-form .terms_cls{margin-left:154px; float:left;}

@media only screen and (max-width:767px){
.inner-page > h4{width:100%;}
}

@media only screen and (max-width:360px){
.errorMessage{margin-left:0px;}
.btn.btn-primary {margin-left:0px;}
#Users_agree_to_terms{margin-left:0px;}
#Users_agree_to_terms_em_ {margin-left:0px;}
}
...
if(!empty($_REQUEST['flag'])){ ?>
    ...
    <div id="dial_message_container">
        ...
        <p style="line-height: 20px">Your account has been created. To continue, please click the activation
        link that has been sent to your email.</p>
        <a href="javascript:;" id="view_btn" class="button-tab" style="margin: 10px auto !important; float:none; display:table;">OK</a>
    </div>
            ...
            <div class="form">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <a href="javascript: void(0)"> Agree to our terms of use </a>
