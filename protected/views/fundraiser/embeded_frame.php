...
<div class="left_part_div">
    ...
    ?>
                            <div class="slide">
                                <h4 class="teg1-h4 case_ttl" style="font-weight: lighter;"><?php echo $fundraiser->getTypeName(); ?></h4>
                                <a class="image_box" href="<?php echo $fundraiser->getAbsoluteURL(); ?>" target="_blank">
                                    <div class="clear"></div>
