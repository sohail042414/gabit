 ...
 */
class CommunityFundraiser extends Fundraiser
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('user_id, no_of_embedsite, project_category,fund_manager', 'numerical', 'integerOnly'=>true),
			...
			array('fundraiser_description, use_of_funds, funds_achieve, updated_date, tell_ur_fund_story, video,project_category,project_category_other,fund_manager,fund_mange_phone,project_champion_name,lead_supptr_phone,ftype_typ_other,benifi_type,reward_program', 'safe'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'benifiry_name' => 'Community Name',
			'benifi_age' => 'Beneficiary Age',
			'benifi_sex' => 'Beneficiary Sex',
			'benifi_email' => 'Beneficiary Email',
			'uplod_pic_benif' => 'Upload Beneficiary Image',
			
			// 'lead_supporter_not_sure' => 'Lead Supporter Not Sure',
			// 'lead_supporter_i_am' => 'Lead Supporter I Am',
