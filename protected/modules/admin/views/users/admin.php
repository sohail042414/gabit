<div class="col-sm-12">
    <section class="panel">
        ...
        <header class="panel-heading">
            ...
            Manage Users (<?php echo $users_count; ?>)
                ...
                $this->widget('CoreButtonCMenu', array(
                    ...
                    'items' => array(
			            array(
                            ...
                            'url' => array('users/newentry'),
                            'visible' => $this->auth->canView($this->resource_id),
                        ),
                        array(
                            'label' => 'Export All Login Users Data', 
                            'url' => array('users/exportlogin'),
                            'visible' => $this->auth->canUpdate($this->resource_id),
                        ),
                        array(
                            'label' => 'Export All Registration Data', 
                            'url' => array('users/export'),
                            'visible' => $this->auth->canUpdate($this->resource_id),
                        ),
                        array(
