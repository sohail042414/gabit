<?php
$deleteJS = <<<DEL
$('.comment').on('click','.time a.delete',function() {
	var th=$(this),
...
<div class="comment" id="c<?php echo $data->id; ?>">
	...
	<div class="author">
		<?php echo $data->authorLink; ?> says on <strong><?php echo $data->post->title;?></strong>
<!--		--><?php //echo CHtml::link(CHtml::encode($data->post->title), $data->post->url); ?>
	...
	<div class="time">
		...
		<?php echo date('F j, Y \a\t h:i a',strtotime($data->created_date)); ?>
	</div>
