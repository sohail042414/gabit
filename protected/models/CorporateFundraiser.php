 ...
 */
class CorporateFundraiser extends Fundraiser
{

	public $project_category = '';
	public $project_category_other='';
	...
	public function rules()
	{
		...
		return array(
			...
			//array('ftype_id,ftype_typ', 'required', 'message' => 'Please select Fundraiser Type'), 
			...
			array('ftype_typ_other', 'length', 'max'=>50),			
			...
			//array('community_name', 'length', 'max'=>200),			
			array('fundraiser_description, use_of_funds, funds_achieve, updated_date, tell_ur_fund_story, video,project_category,project_category_other,fund_mange_phone,lead_supptr_phone,ftype_typ_other,benifi_type,fund_manager,lead_supptr_bg_image,reward_program', 'safe'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'uplod_pic_benif' => 'Uplaod Beneficiary Image',
			'lead_supporter_not_sure' => 'Lead Sponsor Not Sure',
			...
			'uplod_pic_lead_supptr' => 'Upload Logo or Image of Lead Sponsor',
			'lead_supptr_bg_image' => 'Upload Lead Sponsor Background Image',
			'fund_mange_sure' => 'Fund Manager Sure',
			'fund_mange_idea' => 'Fund Manager Idea',
			'fund_mange_name' => 'Fund Manager',
			...
			'champion_logo' => 'Upload Champion Logo Or Image',
			'champion_bg_image' => 'Upload Champion Background Image',
			'fund_manager_option' => 'Fund Manager',
			'fund_manager' => 'Fund Manager',
			'benifi_type' => 'Beneficiary Type', 
			'benifi_name_not_applicable' => 'Not Applicable',
			'project_category_other'=>'Category Name',
