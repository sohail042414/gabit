...
class UtilityHtml extends CHtml
{
    ...
    public function get_fundraiser_full_image_from_path($path, $class = '', $alt = '')
    {
        return "<img src='" . SITE_ABS_PATH_FUNDRAISER_IMAGE . $path . "' class='" . $class . "' alt='" . $alt . "' />";
    }
    ...
    public function get_category_image_path($path, $class = '', $alt = '')
    {
        return "<img src='" . SITE_ABS_PATH_FUNDRAISER_IMAGE_THUMB . $path . "' class='" . $class . "' alt='" . $alt . "' />";
    }
    ...
    public static function get_notification_count_for_admin()
    {
        ...
        $return_message_count = Notifications::model()->count(array('condition' => 'to_admin="Y" AND is_read="N" AND status="Y"'));
        $return_count=$return_count+$return_message_count;
