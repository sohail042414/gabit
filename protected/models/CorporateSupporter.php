 ...
 */
class CorporateSupporter extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('image, website_url', 'length', 'max'=>255),
			array('image_file', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, image, website_url', 'safe', 'on'=>'search'),
		);
	}
