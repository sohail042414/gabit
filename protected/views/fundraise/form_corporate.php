...
?>
<div class="kousr">
    <h4 style='font-weight: normal;'>You are setting up a fundraiser as a corporate organization to champion a project with support from the general public</h4>    
</div>
<div class="box-body bbbb" >            
    ...
    <div class="form-group" >
        ...
        <?php echo $form->dropDownList($model,'ftype_typ',$ftype_list, array('prompt' => '– Please Select –')); ?>
    ...
    <div class="form-group" style="display:none;">
        ...
        <?php echo $form->fileField($model, 'champion_logo', array('maxlength' => 250, 'class' => 'upload_file'));
            if (!empty($model->champion_logo)) {
                echo '<input type="hidden" id="HomeSlider_slider_image" maxlength="250" name="CommunityFundraiser[champion_logo]" value="' . $model->champion_logo . '">';
    ...
    <div class="form-group" style="display: none;">
        ...
        <?php echo $form->fileField($model, 'champion_bg_image', array('maxlength' => 250, 'class' => 'upload_file'));
            if (!empty($model->champion_bg_image)) {
                echo '<input type="hidden" id="HomeSlider_slider_image" maxlength="250" name="CommunityFundraiser[champion_bg_image]" value="' . $model->champion_bg_image . '">';
