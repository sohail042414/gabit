...
<div class="supporter_right">
    ...
    <a class="link_signup" href="<?php echo Yii::app()->createUrl('fundraiser/supporter_login',array('fundraiser_id' => $fundraiser->id)); ?>">Login</a> 
    <div id="sighup_form" class="container_signup">
        <h4>Sign up</h4>
        <div class="clear"></div>
        <div class="form">
            <?php
            ...
            <div class="box-body">
                ...
                <?php echo $form->hiddenField($model, 'fundraiser_id', array('type' => "hidden", 'value' => $_REQUEST['id'])); ?>
                <div class="row">
