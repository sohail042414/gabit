                                                            ...
                                                            <div class="carousel-inner">
                                                                ...
                                                                <div class="carousel-item active">
                                                                    <div class="top-donor-block">
                                                                        <img src="<?php echo SITE_ABS_PATH_FUNDRAISER_IMAGE_THUMB . $winner->image1; ?>"
                                                                ...
                                                                <div class="carousel-item">
                                                                    <div class="top-donor-block">
                                                                        <img src="<?php echo SITE_ABS_PATH_FUNDRAISER_IMAGE_THUMB . $winner->image2; ?>"
                                                                            class="d-block w-100" alt="...">
                                                                    </div>
                                                                </div>
                                                                <?php } ?>
                                                                ...
                                                                <div class="carousel-item">
                                                                    <div class="top-donor-block">
                                                                        <img src="<?php echo SITE_ABS_PATH_FUNDRAISER_IMAGE_THUMB . $winner->image3; ?>"
                                                                            class="d-block w-100" alt="...">
                                                                    </div>
                                                                </div>
                                                                <?php } ?>
                                                                ...
                                                                <div class="carousel-item">
                                                                    <div class="top-donor-block">
                                                                        <img src="<?php echo SITE_ABS_PATH_FUNDRAISER_IMAGE_THUMB . $winner->image4; ?>"
                                                                            class="d-block w-100" alt="...">
                                                                    </div>
                                                                </div>
                                                                <?php } ?>
