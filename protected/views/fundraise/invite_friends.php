                    ...
                    <?php } ?>
                       ...
                       //$model = new InviteFriendForm();
                        ...
                        <div class="box-body">
                            ...
                            <?php if($_REQUEST['type']== 'email'){ ?>  
                            <?php $fundraisersList = Fundraiser::model()->getMyFundraisersList(); ?>
                            
                            <div class="form-group">
                                <?php echo $form->labelEx($model, 'fundraiser_name'); ?>                                
                                <?php echo $form->dropDownList($model, 'fundraiser_name',$fundraisersList,array('prompt' => '-- Please Select Fundraiser --')); ?>
                                <?php echo $form->error($model, 'fundraiser_name'); ?>
                            </div>

                            <div class="form-group">
                                <?php echo $form->labelEx($model, 'greeting'); ?>                                
                                <?php echo $form->textField($model, 'greeting', array('placeholder'=>'My guy how far','maxlength' => 50,'style'=>'width:460px')); ?>
                                <?php echo $form->error($model, 'greeting'); ?>
                            </div>
