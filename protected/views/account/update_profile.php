                ...
                <div id="user_profile">
                    ...
                    <div class="form">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <div class="label_cls"><?php //echo $form->labelEx($model,'agree_to_terms'); 
                                                        ?></div>
                                <div> <?php //echo $form->labelEx($model,'agree_to_terms'); 
                                        ?></div>
                                <div class="input_cls chektext">
                                    <lebel><?php echo $form->checkBox($model, 'agree_to_terms', array('value' => '0', 'uncheckValue' => '1'), array('checked' => 'checked')); ?><span>Agree to our terms of service</span></lebel>
...
<script>
    ...
    $('#users-form').on('afterValidate', function(event, messages, errorAttributes) {

        startLoader();
        if ($.isEmptyObject(messages)) {
            // Client-side validation passed, call your function here
            startLoader();
        }
    });
