...
<h4 id="dial_message">
Your report has been successfully sent.</h4>
<a href="javascript:;" id="view_btn" class="button-tab" style="margin: 10px auto; float:none; display:table;">Done</a>
</div>
<div id="card_payment_div" style="display: none;">
<a href="javascript:;" id="view_btn_ok" class="button-tab" style="margin: 10px auto; float:none; display:table;">Ok</a>
</div>
