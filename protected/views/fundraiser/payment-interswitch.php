...
<form method='post' action='<?php echo $interswitch_settings['payment_url']; ?>'>
    <input type="hidden" name='merchant_code' value='<?php echo $interswitch_settings['merchant_code']; ?>' />
    <input name='pay_item_id' type="hidden" value='<?php echo $interswitch_settings['pay_item_id']; ?>' />
    <input name='site_redirect_url' type="hidden" value="<?php echo $interswitch_return_url; ?>" /> 
    ...
    <input name='currency' type="hidden"  value='<?php echo $interswitch_settings['currency']; ?>' />
    <?php /* ?>
