...
<div class="inner-container">
    <div class="inner-left">
       ...
       <?php //if( Yii::app()->request->urlReferrer == SITE_ABS_PATH."index.php/fundraise/index") {?>
         <?php if( Yii::app()->request->urlReferrer == SITE_ABS_PATH."index.php/fundraise/index" && $_REQUEST['bck']==1) {?>
        <a href="<?php echo $this->createUrl('fundraise/index') ?>" class="button-tab">Back</a>
        <?php } ?>
