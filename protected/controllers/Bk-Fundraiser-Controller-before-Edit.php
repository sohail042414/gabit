...
class FundraiserController extends FrontCoreController
{
    ...
    public function actionDonations($id)
    {
        ...
        if (isset($_POST['Transactions'])) {        
            $trans_ref = base64_encode("giveyourbit".time());
    ...
    public function actionOptions()
    {
        ...
        $message_html = str_replace('{donation_amount}',$transaction->donation_amount,$message_html);
    ...
    public function actionPayment()
    {
        ...
        $return_url = Yii::app()->createAbsoluteUrl('fundraiser/completepayment');
    ...
    public function actionManagefundraiser(){
        ...
        if(!empty($_POST['SetupFundraiser']) || !empty($postData)){
            ...
            if ($send_message->save(false)) {
                ...
                //mail($to, $subject, $message, $headers, $from );
                //$this->send_email($to,$subject,$message,$message);           
            }
